...
\addlinespace
\textbf{10} Métodos de coleta & Descreve os tipos de dado, os procedimentos e a duração do trabalho de campo & etapa formativa, entrevistas semiestruturadas abertas com duração declarada, entradas em campo de reconhecimento territorial \\
\addlinespace
...
\addlinespace
\textbf{12} Unidades de estudo & Define o número e as características dos participantes, documentos e eventos & etapa formativa, cinco entrevistas codificadas, entradas em campo em cinco comunidades e corpus documental de fonte prévia \\
\addlinespace
...
\addlinespace
\textbf{15} Técnicas de confiabilidade & Nomeia as estratégias que sustentam a credibilidade dos achados & Parágrafo de critérios de rigor ao final da etapa formativa, com triangulação, conferência pelo participante, planilha de rastreabilidade e cadeia de evidência \\
\addlinespace
\textbf{16} Síntese e interpretação & Apresenta os achados principais e sua interpretação & Resultados e Discussão, achados da etapa formativa \\
\addlinespace
...
\addlinespace
\textbf{18} Integração com trabalho prévio e contribuição & Relaciona os achados à literatura e discute transferibilidade & Triangulação Documental com Registros Locais Prévios e Especificações de Adaptação Produzidas na etapa formativa \\
\addlinespace

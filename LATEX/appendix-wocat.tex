...
%% =========================================================
\subsection*{9\quad Seção Suplementar --- Itens para Avaliação de Vulnerabilidade Biocultural ($V_1$--$V_6$)}
\label{sec:suplementar}

\noindent\textit{Esta seção contém itens suplementares não cobertos pelo questionário WOCAT original, desenvolvidos para operacionalizar as seis dimensões de vulnerabilidade biocultural ($V_1$--$V_6$) em contexto de comunidades quilombolas. Os itens estão organizados em três camadas de coleta conforme a natureza da variável.}

%% ---------------------------------------------------------
\subsubsection*{Camada~1 --- Autorrelato (respondido pelo agricultor/líder comunitário)}

%% --- V1 ---
\paragraph{9.1\quad Transmissão intergeracional e dimensão ritual ($V_1$ --- Erosão Intergeracional)}~\\[4pt]
...
%% --- V6 ---
\paragraph{9.2\quad Governança comunitária e capital social ($V_6$ --- Organização Social)}~\\[4pt]
...
%% --- V2 ---
\paragraph{9.3\quad Agrobiodiversidade e etnotaxonomia ($V_2$ --- Complexidade Biocultural)}~\\[4pt]
...
%% --- V3 ---
\paragraph{9.4\quad Singularidade e exclusividade territorial ($V_3$ --- Singularidade Territorial)}~\\[4pt]
...
%% --- V4 ---
\paragraph{9.5\quad Diagnóstico de déficit documental ($V_4$ --- Status de Documentação)}~\\[4pt]
...
%% --- V5 ---
\paragraph{9.6\quad Proteção jurídica e propriedade intelectual ($V_5$ --- Vulnerabilidade Jurídica)}~\\[4pt]

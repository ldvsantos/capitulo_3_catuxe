...
\midrule
$V_1$ & Eros\~ao Intergeracional & \S2 Descri\c{c}\~ao; \S6.1 Impactos socioculturais & Propor\c{c}\~ao de jovens praticantes, taxa de transmiss\~ao ativa, significado ritual vinculado \`a pr\'atica \\
$V_2$ & Complexidade Biocultural & \S3 Classifica\c{c}\~ao; \S5 Ambiente natural; \S6.1 Impactos ecol\'ogicos & Agrobiodiversidade (Shannon $H'$, Simpson), riqueza de variedades locais, intera\c{c}\~oes solo-planta codificadas \\
$V_3$ & Singularidade Territorial & \S3 Classifica\c{c}\~ao; \S5 Ambiente natural & Beta-diversidade de pr\'aticas entre comunidades, endemismo de variedades, propor\c{c}\~ao de pr\'aticas exclusivas \\
$V_4$ & Status de Documenta\c{c}\~ao & \S2 Descri\c{c}\~ao; \S6.5 Ado\c{c}\~ao; \S7 Refer\^encias & N\'umero de saberes com registro formal, completude de fichas t\'ecnicas, taxa de digitaliza\c{c}\~ao de acervos \\
$V_5$ & Vulnerabilidade Jur\'idica & \S5.6 Caracter\'isticas dos usu\'arios; \S5.8 Propriedade & Mecanismos formais de prote\c{c}\~ao (IG, marca coletiva, registro IPHAN), exist\^encia de protocolo comunit\'ario \\
$V_6$ & Organiza\c{c}\~ao Social & \S5.9 Infraestrutura; \S6.1 Institui\c{c}\~oes comunit\'arias; \S6.5 Ado\c{c}\~ao & Mestres de saberes ativos, frequ\^encia de eventos de transmiss\~ao, redes de coopera\c{c}\~ao, equidade de g\^enero \\
\bottomrule
\end{tabular}
\end{table}
...
Os Saberes e Sistemas Agrícolas Tradicionais (SSAT) quilombolas são governados pelo complexo Conhecimento-Prática-Crença (K-P-B) descrito por \citet{Toledo2008}, onde crenças funcionam como regulador ético-cosmológico do manejo. Esses sistemas exemplificam manejo adaptativo de longa duração \citep{Berkes2017}, constituindo patrimônio biocultural no qual diversidade biológica e diversidade cultural co-evoluem \citep{Maffi2001,Pretty2009}.
